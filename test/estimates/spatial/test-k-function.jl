...
import SpatialMultitaper: getestimate, getargument, KFunction

#
@testset "K-function tests" begin
    rng = StableRNG(123)
        ...
        @testset "Return type: $return_type" for return_type in [:single, :tuple, :vector]
            ...
            @testset "Partial k-function from partial spectra" begin
                if n_processes > 1
                    ...
                    @test getargument(k_from_partial) ≈ radii
                end
            end
            ...
            @testset "Partial k-function from partial C-function" begin
                if n_processes > 1
                    ...
                    @test getargument(k_from_partial_c) ≈ radii
            ...
            @testset "K-function specific properties" begin
                ...
                @test getargument(k_from_c) ≈ getargument(k_result)
