@testset "check_spatial_data" begin
    ...
    @test ((p2, p3), 2) == Spmt.check_spatial_data((p2, p3))
    @test_throws AssertionError Spmt.check_spatial_data((p1, p2))
    @test_throws AssertionError Spmt.check_spatial_data((p1, p3))
    ...
    @test_throws AssertionError Spmt.check_spatial_data((pattern, griddata))
    @test_throws AssertionError Spmt.check_spatial_data((domain(pattern), griddata))
    @test_throws AssertionError Spmt.check_spatial_data([domain(pattern), griddata])
